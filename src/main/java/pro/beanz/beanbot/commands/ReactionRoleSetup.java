package pro.beanz.beanbot.commands;
...
import pro.beanz.beanbot.commands.lib.CommandData;
import pro.beanz.beanbot.reactionroles.ReactionRoleListener;
import pro.beanz.beanbot.reactionroles.states.CreateB;
import pro.beanz.beanbot.reactionroles.states.Exit;
import pro.beanz.beanbot.reactionroles.states.ModifyB;
import pro.beanz.beanbot.reactionroles.states.ModifyD;
import pro.beanz.beanbot.reactionroles.states.RemoveB;
import pro.beanz.beanbot.reactionroles.states.RemoveC;
import pro.beanz.beanbot.reactionroles.states.Start;
import pro.beanz.beanbot.reactionroles.states.State;
...
public class ReactionRoleSetup extends Command {
    private static Logger log = LoggerFactory.getLogger(ReactionRoleSetup.class);

    ReactionRoleListener listener;

    public ReactionRoleSetup() {}

    @Override
    public void execute(MessageReceivedEvent event, String[] args) {
        if (!event.isFromGuild()) { throw new NullPointerException(PRIVATE_MESSAGE_ERROR); }
    ...
    public class SetupListener extends ListenerAdapter {
        ...
        public Message getConfigMessage() { return configMessage; }
    }
}