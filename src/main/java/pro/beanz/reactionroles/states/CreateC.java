...
public class CreateC extends State {
    ...
    public CreateC(IEventManager eventManager, ListenerAdapter listenerAdapter, Message target,
    ...
    public MessageEmbed getMessageEmbed() {
        ...
        builder.setDescription("Input the role ID of the role you would like to link to this emote");
